...
<div id="ilan">Teknik bi arza var lütfen 0531 965 00 78 haber verin.!!</div>
<div id="icerik">
<br/>
<center><h1> Silincek ilanın numarası: </h1><center> <form method="post" action="deletes.php"> <input type="text" name="delete" /> <input type="submit" /> </form>  
